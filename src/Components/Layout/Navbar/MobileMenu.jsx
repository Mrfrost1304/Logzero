  ...
  return (
    <div className="relative md:hidden" ref={menuRef}>
      ...
      <button
        ...
        className="p-2 -m-2 rounded-md hover:bg-gray-100/20"
      >
...
const NavItem = ({ label, onClick }) => (
  <li>
    <button
      role="menuitem"
      className="w-full text-left px-6 py-4 text-lg font-medium text-gray-900 hover:bg-gray-50 active:bg-red-600 transition-colors focus:bg-red-600 focus:text-white"
      onClick={onClick}
    >
      {label}
    </button>
